...
QC3Control::QC3Control(byte DpPin, byte DmPin) : _DpPin(DpPin),
                                                 _DmPin(DmPin),
...
{
  pinMode(_DmPin, INPUT_PULLUP); // Set D- to about 0.6V
}
...
{
  pinMode(_DpPin, INPUT_PULLUP); // Set D+ to about 0.6V
}
